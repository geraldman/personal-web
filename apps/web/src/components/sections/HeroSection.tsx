    ...
    <section ref={heroRef} className="relative isolate min-h-screen overflow-hidden">
      ...
      <div className="relative z-20 flex min-h-[100vh] items-center">
        <div className="container-width flex w-full flex-col items-center justify-center px-4 py-12 text-center sm:px-6">
          <p
            className="animate-hero-fade-in-up mb-4 inline-flex w-fit items-center rounded-full border border-[var(--color-border)] bg-[var(--color-accent-dim)] px-3 py-2 font-mono text-[10px] uppercase tracking-[0.14em] text-[var(--color-accent)] sm:px-4 sm:text-xs sm:tracking-[0.16em]"
          >
            <motion.span
          ...
          <h1
            className="animate-hero-fade-in-up animation-delay-120 text-gradient text-5xl font-semibold leading-[1.05] sm:text-6xl lg:text-7xl xl:text-8xl"
          >
            Hi, I&apos;m Gerald
          </h1>

          <p
            className="animate-hero-fade-in-up animation-delay-240 mt-5 max-w-2xl text-base text-[var(--color-text-secondary)] lg:text-xl"
          >
            Security-focused Informatics Student & Full-Stack Engineer.
          </p>

          <p
            className="animate-hero-fade-in-up animation-delay-360 mt-3 max-w-2xl text-pretty text-sm leading-relaxed text-[var(--color-text-secondary)] sm:text-base lg:text-lg"
          >
          ...
          <div
            className="animate-hero-fade-in-up animation-delay-480 mt-8 flex flex-wrap justify-center gap-3"
          >
