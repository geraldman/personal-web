...
import { FiAward, FiCode, FiFolder, FiGitCommit } from "react-icons/fi";
...
const STAT_ICON_MAP: Record<StatTickerIcon, ReactNode> = {
  ...
  certificates: <FiAward className={statIconClassName} aria-hidden="true" />,
};
      ...
      <div className="container-width grid gap-10 lg:grid-cols-5">
        <div className="order-last lg:order-first lg:col-span-3">
          ...
          <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2">
            {statTicker.map((fact) => (
            <div key={fact.id} className="glass rounded-2xl p-6">
        ...
        <div className="order-first lg:order-last lg:col-span-2 flex align-middle">
          <div className="relative mx-auto flex w-full max-w-[16.5rem] overflow-hidden rounded-3xl border border-[var(--color-border)] transition-colors duration-[250ms] ease-[cubic-bezier(0.25,0.46,0.45,0.94)] hover:border-[var(--color-text-primary)] sm:max-w-[19rem] md:max-w-[22rem] lg:mx-0 lg:max-w-none">
